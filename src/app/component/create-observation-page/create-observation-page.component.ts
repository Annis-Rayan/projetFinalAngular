...
@Component({
  selector: 'app-create-observation-page',
  templateUrl: './create-observation-page.component.html',
  styleUrls: ['./create-observation-page.component.css']
})
export class CreateObservationPageComponent implements OnInit {
  ...
  constructor(private httpClient: HttpClient, private animalService: AnimalService,
    ...
    this._dateObservationCtrl = fb.control('', CreateObservationPageComponent.checkDate);
